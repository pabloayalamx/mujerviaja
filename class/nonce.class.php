...
class Nonce {
    ...
    public function generateNonce($length = 10, $form_id, $expiry_time, $secret){
        //our secret
        // $secret = NONCE_SECRET;
        ...
        $nonce = $salt .':'.$time.':'.hash('sha256', $toHash);
        //store Nonce
        self::storeNonce($form_id, $nonce);
        //return nonce
        return $nonce;
    }
   public function verifyNonce($nonce, $secret){
        //our secret
        // $secret = NONCE_SECRET;
